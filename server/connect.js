class Game {
  ...
  //creates a 2d array filled with 0's
  makeBoard() {
    let board = [];
  ...
  //look from bottom to top of clicked column to see if a space is available for a chip
  setCell(col){
    ...
    //nothing is returned when the column is full
  }
